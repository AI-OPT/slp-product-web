...
public class ProductCommentController {
	...
	@ResponseBody
	private ResponseData<PageInfo<CommentPageInfo>> queryCommentList(HttpServletRequest request,CommentPageRequest params,String commentTimeBeginStr, String commentTimeEndStr) {
		...
		try {
			...
			if(commentPageInfo != null){
				...
				ISysUserQuerySV userService = DubboConsumerFactory.getService(ISysUserQuerySV.class);
...
//						SysUserQueryResponse userInfo = userService.queryUserInfo(userQuery);
//						pageInfo.setUserName(userInfo.getName());
