define('app/jsp/saleprice/salePriceList', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    var clickId = "";
    //定义页面组件类
    var salePriceList = Widget.extend({
    	...
    	//重写父类
    	setup: function () {
			salePriceList.superclass.setup.call(this);
    		...
    		$("#pagination-ul").runnerPagination({
	            ...
	            */
	 			data: {"productCatId":productCatId,"productType":productType,"productId":productId,
	           	...
	           	pageSize: salePriceList.DEFAULT_PAGE_SIZE,
	           	visiblePages:5,
